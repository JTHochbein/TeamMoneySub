...
OMB_Waiter wait = new OMB_Waiter();
    ...
    public void clicks_on_neue_elf_erstellen() {
        //driver.manage().timeouts().implicitlyWait(2, TimeUnit.SECONDS);
        wait.forit(Transfer.getClickElfErstellenBy(), 10000);
    ...
    //LF
        ...
        WebElement textElement = Transfer.getOutputText();
        String text = textElement.getText();

// Extrahieren der Zahl
        String[] parts = text.split(":");
        String zahl1 = parts[0].trim();

// Ausgeben der Zahl und des Doppelpunkts
        System.out.println("Best Player of the World: " + zahl1);
